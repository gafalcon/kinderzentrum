...
from cita.views import ReservarCitaView, CitasListView, BusquedaCitasView, eliminar_cita_view, CitaEditView, cita_view, BusquedaTerapistaView, BusquedaTipoTerapiaView, BusquedaPacienteView
...
urlpatterns =[ 
    ...
    url(r'busqueda_paciente/', BusquedaPacienteView.as_view(), name='busqueda_paciente'),
    url(r'busqueda_tipoterapia/', BusquedaTipoTerapiaView.as_view(), name='busqueda_tipoterapia'),
    url(r'busqueda_terapista/', BusquedaTerapistaView.as_view(), name='busqueda_terapista'),

# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-03-23 04:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jornada', models.PositiveSmallIntegerField(choices=[(0, b''), (1, b'Tiempo completo'), (2, b'Medio tiempo'), (3, b'Por horas')], verbose_name=b'jornada de trabajo')),
            ],
        ),
        migrations.CreateModel(
            name='Gestacion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo_sanguineo', models.CharField(choices=[('o+', 'O+'), ('o-', 'O-'), ('a+', 'A+'), ('a-', 'A-'), ('b+', 'B+'), ('b-', 'B-'), ('ab+', 'AB+'), ('ab-', 'AB-')], max_length=4, verbose_name='grupo sanguineo')),

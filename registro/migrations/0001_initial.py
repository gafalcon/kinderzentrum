# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-03-16 06:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tiempo_leche_materna', models.PositiveSmallIntegerField(choices=[(0, b'1 - 4 Meses'), (1, b'5 - 6 Meses'), (2, b'7 - 8 Meses'), (3, b'9 - 12 Meses'), (4, b'13 - 18 Meses'), (5, b'19 - 24 Meses')])),
                ...
                ('lugar_comida_media_manana', models.CharField(max_length=50, verbose_name=b'media ma\xc3\xb1ana')),
                ('lugar_almuerzo', models.CharField(max_length=50, verbose_name=b'almuerzo')),
                ('lugar_comida_media_tarde', models.CharField(max_length=50, verbose_name=b'media tarde')),
                ('lugar_cena', models.CharField(max_length=50, verbose_name=b'cena')),
                ('lugar_comida_otro', models.CharField(max_length=50, verbose_name=b'otro')),

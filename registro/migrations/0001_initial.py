# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-01 14:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tiempo_leche_materna', models.PositiveSmallIntegerField(blank=True, choices=[(0, b'1 - 4 Meses'), (1, b'5 - 6 Meses'), (2, b'7 - 8 Meses'), (3, b'9 - 12 Meses'), (4, b'13 - 18 Meses'), (5, b'19 - 24 Meses')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hermano_transtorno', models.PositiveSmallIntegerField(blank=True, verbose_name=b'\xc2\xbfCu\xc3\xa1l de los hermanos? (Orden en que naci\xc3\xb3)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo_sanguineo', models.CharField(choices=[('A+', 'A+'), ('A-', 'A-'), ('O+', 'O+'), ('O-', 'O-'), ('B+', 'B+'), ('B-', 'B-'), ('AB+', 'AB+'), ('AB-', 'AB-')], max_length=4, verbose_name='grupo sanguineo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiempo_apego_precoz', models.PositiveSmallIntegerField(blank=True, verbose_name=b'\xc2\xbfCu\xc3\xa1nto tiempo dur\xc3\xb3 el apego precoz?')),
                ...
                ('tiempo_internado', models.DurationField(blank=True, verbose_name=b'\xc2\xbfCu\xc3\xa1nto tiempo permaneci\xc3\xb3 internado(a)?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.SmallIntegerField(choices=[(1, b'REHABILITACI\xc3\x93N F\xc3\x8dSICA'), (2, b'ESTIMULACI\xc3\x93N TEMPRANA'), (3, b'INTEGRACI\xc3\x93N SENSORIAL'), (4, b'HIPOTERAPIA'), (5, b'LENGUAJE'), (6, b'PSICOPEDAG\xc3\x93GICA'), (7, b'TERAPIA FAMILIAR'), (8, b'NINGUNA')], verbose_name=b'Tipo de terapia')),
                ('costo_sesion', models.PositiveSmallIntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefonos', models.CharField(max_length=50)),
                ('fecha_nacimiento', models.DateField(verbose_name=b'fecha de nacimiento')),
                ('grupo_sanguineo', models.CharField(choices=[(b'A+', b'A+'), (b'A-', b'A-'), (b'O+', b'O+'), (b'O-', b'O-'), (b'B+', b'B+'), (b'B-', b'B-'), (b'AB+', b'AB+'), (b'AB-', b'AB-')], max_length=4, verbose_name=b'grupo sanguineo')),
                ('terapia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='registro.Terapia')),
            ],
        ),
        migrations.AddField(
            model_name='paciente',

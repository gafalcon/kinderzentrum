    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edad_disc_molestia', models.PositiveSmallIntegerField(blank=True, verbose_name=b'\xc2\xbfA qu\xc3\xa9 edad notaron estas molestias?')),
                ...
                ('edad_crisis', models.PositiveSmallIntegerField(blank=True, verbose_name=b'\xc2\xbfA qu\xc3\xa9 edad fue la primera crisis?')),
            ],
        ),
        migrations.CreateModel(
            name='Familiar',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('momento_desc_embarazo', models.CharField(max_length=250, verbose_name=b'\xc2\xbfEn que momento se enter\xc3\xb3 que estaba embarazada?')),
                ('lugar_curso_prenatal', models.CharField(blank=True, max_length=100, verbose_name=b'\xc2\xbfEn que lugar fue el curso prenatal?')),
                ('carga_horaria', models.CharField(blank=True, max_length=100, verbose_name=b'\xc2\xbfCuanto fue la carga del curso prenatal?')),
                ('vacuna_tetano', models.BooleanField(verbose_name=b'\xc2\xbfSe vacun\xc3\xb3 usted contra el tetano durante el embarazo?')),
                ('comunicacion_bebe', models.CharField(max_length=500, verbose_name=b'\xc2\xbfC\xc3\xb3mo se comunicaba con el bebe? Marque todas las opciones que dese.')),
            ],
        ),
        migrations.CreateModel(
            name='Hermano',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('terapia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='registro.Terapia_Paciente')),
            ],
        ),
        migrations.AddField(
            model_name='paciente',

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_actividad', models.CharField(default=b'---', max_length=100)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sentimientos', models.CharField(max_length=200, verbose_name=b'\xc2\xbfQu\xc3\xa9 sinti\xc3\xb3 cuando se enter\xc3\xb3 que estaba embarazada? Marque todas las opciones que desee')),
                ('num_embarazo', models.PositiveSmallIntegerField(verbose_name=b'\xc2\xbfQu\xc3\xa9 n\xc3\xbamero de embarazo es este?')),
                ('momento_desc_embarazo', models.PositiveSmallIntegerField(verbose_name=b'\xc2\xbfEn que momento se enter\xc3\xb3 que estaba embarazada?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.SmallIntegerField()),
                ('periodo', models.SmallIntegerField(choices=[(1, b'1er Trimestre'), (2, b'2do Trimestre'), (3, b'3er Trimestre')])),
                ('nombre_situacion', models.CharField(default=b'---', max_length=100)),
